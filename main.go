...
func init() {
	...
	// perm 日志文件权限
	logs.SetLogger(logs.AdapterMultiFile, `{"filename":"./logs/metal.log","level":6,"maxlines":0,"maxsize":0,"daily":true,"maxdays":30,"separate":["emergency", "alert", "critical", "error", "warning", "notice", "info", "debug"]}`)
}

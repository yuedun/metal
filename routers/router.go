...
func init() {
	...
	ns := beego.NewNamespace("/admin",
		...
		beego.NSNamespace("/page",
			...
			beego.NSRouter("/article-route", &controllers.AdminController{}, "get:CreateArticleRoute"),
			...
			beego.NSRouter("/logs-route", &controllers.AdminController{}, "get:LogsRoute"),
		...
		beego.NSNamespace("/api",
			...
			beego.NSRouter("/uploadImg", &controllers.AdminController{}, "post:UploadImg"),

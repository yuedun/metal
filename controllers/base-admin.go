...
var NeedPermission = map[string]bool{
	...
	"AdminPageController:ArticleCreate": false,
	...
	"AdminPageController:PictureList":   false,
	...
	"UserAPIController:UserUpdate":         true,
	"AdminAPIController:UserDelete":        true,
	"AdminAPIController:GetRolesList":      false,
	"AdminAPIController:RoleCreate":        true,
	"AdminAPIController:RoleUpdate":        true,
	"AdminAPIController:RoleDelete":        true,
	"ArticleAPIController:ArticleCreate":   true,
	"ArticleAPIController:ArticleEdit":     true,
	"ArticleAPIController:ArticleDelete":   true,
	"ArticleAPIController:ArticleList":     false,
	...
	"AdminAPIController:PictureList":       false,
